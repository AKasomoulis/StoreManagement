...
public class SupplierDaoImpl extends JpaDao<Supplier, String> implements SupplierDao {
	...
	public boolean supplierExists(String name) {
		...
		try {
			...
			queryString = "FROM Supplier sup " + "WHERE sup.name = :name";
			query = entityManager.createQuery(queryString);
	...
	public String getVerificationCode(String name) {
		...
		try {
			...
			queryString = "SELECT sup.verificationCode FROM Supplier sup WHERE sup.name = :name";
			query = entityManager.createQuery(queryString);
	...
	public String checkoutCode(String code) {
		...
		try {
			...
			queryString = "SELECT sup.name FROM Supplier sup WHERE sup.verificationCode = :code";
			query = entityManager.createQuery(queryString);
	...
	public Long getNumberOfTotalSuppliers() {
		...
		try {
			...
			queryString = "SELECT COUNT(sup.name) FROM Supplier sup";
			query = entityManager.createQuery(queryString);
