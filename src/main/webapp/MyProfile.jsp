			...
			<aside class="grid col-one-quarter mq2-col-full">
				...
				<menu>
					...
					<% if (!user.getUsername().equals("admin")) { %>
						...
						<button type="button id="apply" type="submit" onclick="submitUpdate()">Update profile</button>
						<br>
						<hr />
						<button id="delete" type="submit" onclick="submitDelete()">Delete account</button>
					<% } %>
...
<!-- 					</header> -->
					...
					<script>
						...
						function submitUpdate() {
							  var x = confirm("Are you sure you want to update your profile?");
							  if (x) {
								  document.getElementById("UpdateMyProfile").submit();
							      return true;
							  }
							  else
							    return false;
						...
						function submitDelete() {
							  ...
							  if (x) {
								  document.getElementById("DeleteMyAccount").submit();
							      return true;
							  }
							  else
							    return false;
					...
					<td height="220px" width="600" colspan="2" style="text-align: center;">
						
						
					<h4><b>My Profile</b></h4>

					<form action="UpdateMyProfile" method="post" id="UpdateMyProfile">
...
<!-- 						<button id="apply" type="submit">Apply</button> -->
						...
						<input type="hidden" name="hidden2" id="hidden2" value='<%out.print(roleName);%>'>
					...
					<form action="DeleteMyAccount" method="post" id="DeleteMyAccount">
