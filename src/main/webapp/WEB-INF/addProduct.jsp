		...
		<div id="signup-form">
			...
			<div id="signup-inner">
				...
				<form action="AddProduct" method="post">
					...
					<p>
						<%
							out.print("<label for='serialNumber'>Serial Number *</label> <input id='serialNumber'type='text' maxlength='45' name='serialNumber' value='"
									+ serialNumber + "' />");
						%>
					...
					<p>
						<%
							out.print("<label for='type'>Type </label> <input id='type'type='text' maxlength='45' name='type' value='"
									+ type + "' />");
						%>
					</p>
					...
					<p>
						<%
						if (dimensions == -1)
							out.print("<label for='dimensions'>Dimensions </label> <input id='dimensions'type='textarea' name='dimensions' value='"
									+ "" + "' onkeypress='return checkIt(event)' />");
						else
							out.print("<label for='dimensions'>Dimensions </label> <input id='dimensions'type='textarea' name='dimensions' value='"
