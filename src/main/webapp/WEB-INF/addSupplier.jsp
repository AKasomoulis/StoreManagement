		...
		<div id="signup-form">
			...
			<div id="signup-inner">
				...
				<form action="AddSupplier" method="post">
					...
					<p>
						<%
							out.print("<label for='name'>Supplier Name *</label> <input id='name'type='text' maxlength='45' name='name' value='"
									+ name + "' />");
						%>
					...
					<p>
						<%
							out.print("<label for='address'>Address *</label> <input id='address'type='text' maxlength='45' name='address' value='"
									+ address + "' />");
						%>
					</p>
