		...
		<aside class="grid col-one-quarter mq2-col-full">
			...
			<menu>
				<ul>
					...
					<a href=<%=response.encodeURL(request.getContextPath() + "/AllStores")%>>Stores</a><br>
					
					<%
					out.println("<a href=" + response.encodeURL(request.getContextPath() + "/AllStores") + ">Stores1908</a><br>");
					%>
					
					
					<a href="<%=request.getContextPath()%>/AllUsers">Users</a><br>
					<a href="/AllUsers">Users2</a><br>
